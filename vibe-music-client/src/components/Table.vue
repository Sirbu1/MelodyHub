...
<template>
  <el-table :data="data" style="
    ...
    <el-table-column>
      <template #header>
        <div class="grid grid-cols-[auto_4fr_3fr_1fr_2fr_1fr] items-center gap-6 w-full text-left mt-2">
      ...
      <template #default="{ row }">
        <div
          class="grid grid-cols-[auto_4fr_3fr_1fr_2fr_1fr] items-center gap-6 w-full group transition duration-300 rounded-2xl p-2"
          :class="[
