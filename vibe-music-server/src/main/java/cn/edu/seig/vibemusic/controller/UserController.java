...
public class UserController {
    ...
    public Result sendVerificationCode(@RequestParam @Email String email) {
        System.out.println("UserController.sendVerificationCode called with email: " + email);
    ...
    public Result noAuthTest() {
        System.out.println("UserController.noAuthTest called");
        return Result.success("No auth test endpoint works");
    }
